...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{FinalProject/docs/assets/latency_plot.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.75\textwidth]{FinalProject/docs/assets/hbm_plot.png}

...
CUDA implementation of a FlashAttention-style forward pass (Dao et al., 2022) with naive, tiled, causal, warp-centric, and WMMA variants, benchmarked on an NVIDIA Tesla T4.
